...
const projects: Record<WorkType, Project[]> = {
  ...
  motion: [
    { id: '19', title: 'Motion Graphics Showreel', subtitle: 'Motion Branding', thumbnail: 'linear-gradient(135deg, #ff0844 0%, #ffb199 100%)', videoUrl: 'https://player.vimeo.com/video/1134989523?badge=0&autopause=0&player_id=0&app_id=58479', isFrameIo: true },
